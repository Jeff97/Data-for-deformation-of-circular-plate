...
C G is growth tensor
        Lambda1=6.546503751233322*Sqrt(0.15451174289245984**
     &  (7.639437268410976*STATEV(3))* 2
     &  **(15.278874536821952* STATEV(3)) )
        Lambda2=(0.5 +1.618**(-3.819718634205488*STATEV(3))
     &  * Cos(6.283185307179586*(STATEV(3)+0.05)))/STATEV(3)
        TotalT=100.0
C
C
