...
C STATEV(4) - Initial coordinate COORDS(1)
C --------------------------------------------------------------------
C
...
C G is growth tensor
        Lambda1=Sqrt((-268789.536862-14187.1882102*STATEV(3)
     &  +(1.01093857879*10**(6))*STATEV(3)**2-292432.529511*STATEV(3)**3
     &  -516652.255465*STATEV(3)**5+398725.938288*STATEV(3)**6
     &  -83489.7834557*STATEV(3)**7+270078.412683
     &  *Cos(2.61799387799*STATEV(3))-405.277427723
     &  *Cos(5.23598775598*STATEV(3))+33.4457676399
     &  *Cos(10.471975512*STATEV(3)))**2.0+(96.3201037487
     &  -33549.3374364*STATEV(3)+7139.20724857*STATEV(3)**2
     &  -66950.800817*STATEV(3)**3+244016.687875*STATEV(3)**5
     &  -221000.048836*STATEV(3)**6+55337.5475354*STATEV(3)**7
     &  +21712.8462773*Sin(2.61799387799*STATEV(3))-4662.35319642
     &  *Sin(5.23598775598*STATEV(3))-20.4042392283
     &  *Sin(10.471975512*STATEV(3)))**2.0)
        Lambda2=(-49.2917972041-268789.536862*STATEV(3)
     &  -7093.59410512*STATEV(3)**2+336979.526262*STATEV(3)**3
     &  -73108.1323777*STATEV(3)**4-86108.7092441*STATEV(3)**6
     &  +56960.8483269*STATEV(3)**7-10436.222932*STATEV(3)**8
     &  +103162.354562*Sin(2.61799387799*STATEV(3))
     &  -77.4022871348*Sin(5.23598775598*STATEV(3))
     &  +3.19383554723*Sin(10.471975512*STATEV(3)))/STATEV(3)
        TotalT=100.0
C
C
