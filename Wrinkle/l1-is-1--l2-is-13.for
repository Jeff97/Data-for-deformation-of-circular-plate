...
C
     ...
     &    FOUR=4.D0, SIX=6.D0)
        REAL  TotalT,Lambda1,Lambda2,MMOD,G11,G12,G21,G22,G33
C
C ----------------------------------------------------------------
...
C
        ...
        STATEV(2)=1.0+(Lambda2-1.0)*(TIME(1)+DTIME)/TotalT
C
        MMOD=STATEV(3)*STATEV(3)+STATEV(4)*STATEV(4)
        G11=(STATEV(1)*STATEV(3)*STATEV(3)
     &      +STATEV(2)*STATEV(4)*STATEV(4))/MMOD
        STATEV(7)=G11
        IF (G11 .LT. 1.0) THEN
                G11=1.0
        END IF
        G22=(STATEV(1)*STATEV(4)*STATEV(4)
     &      +STATEV(2)*STATEV(3)*STATEV(3))/MMOD
        STATEV(8)=G22
        IF (G22 .LT. 1.0) THEN
                G22=1.0
        END IF
     ...
     &      (STATEV(3)*STATEV(3)-STATEV(4)*STATEV(4))
        STATEV(9)=G12
        G21=G12
        ! G33=1.0+(10.0*STATEV(5))*(TIME(1)+DTIME)/TotalT
        G33=1.0
C
